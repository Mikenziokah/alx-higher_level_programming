...
scripts that do what is described in the comments
...
11.Import the database dump from hbtn_0d_tvshows to your MySQL server: download
...
12.Import the database dump of hbtn_0d_tvshows to your MySQL server: download (same as 10-genre_id_by_show.sql)
...
13.Import the database dump from hbtn_0d_tvshows to your MySQL server: download (same as 11-genre_id_all_shows.sql)
...
14.Import the database dump from hbtn_0d_tvshows to your MySQL server: download (same as 12-no_genre.sql)
...
15.Import the database dump from hbtn_0d_tvshows to your MySQL server: download (same as 13-count_shows_by_genre.sql)
...
16.Import the database dump from hbtn_0d_tvshows to your MySQL server: download (same as 14-my_genres.sql)
...
17.Import the database dump from hbtn_0d_tvshows to your MySQL server: download (same as 15-comedy_only.sql)
