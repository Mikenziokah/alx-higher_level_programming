PYTHON NETWORK #1 PROJECT, FETCHING INTERNET RESOURCES USING urllib PACKAGES

0. Python script that fetches https://alx-intranet.hbtn.io/status
...
4. Python script that fetches https://alx-intranet.hbtn.io/status
